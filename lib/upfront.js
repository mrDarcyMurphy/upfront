...
var glom = function(config, done) {
  // console.log('\n-- config:', upfront.config);
  upfront.config = {}; // reset is necessary because of the way upfront persists across a node session
  // console.log('-- config2:', upfront.config);
  // console.log('-- default_config:', default_config);
  // console.log('-- config', config);
  upfront.config = _.extend(config, default_config);
  // console.log('\n**********\n** FINAL', upfront.config);
  // console.log('**********');
